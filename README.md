...
- `EXPO_PUBLIC_SANITY_API_TOKEN` - Sanity token with write access for API routes.
- _(Optional)_ `EXPO_PUBLIC_EXERCISE_DB_API_URL` - Override the Exercise DB base url. Defaults to `https://v2.exercisedb.dev/api/v1/exercises`.
